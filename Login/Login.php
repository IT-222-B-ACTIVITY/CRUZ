...
$logger = new FileLogger('./login.txt', 'w+');
$logger->log("Hello Tosca" . PHP_EOL);
$logger->log("Welcome!" . PHP_EOL);
// Usage
$flight = new Flight("FLIGHT221", "Japan", "Manila", "2050-09-09", "Michael Tracey, Arbel Perez, Kyle Brianne", "2212312", 50);
...
foreach($logger as $loggers) {
    $loggers->log("Cruz has logged in");
}